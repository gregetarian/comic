 ...
 *
 * Mirrors the CLI's VIEWS dict in comic/render.py (keep the two in sync). Each
...
export const VIEW_ORDER = [
    ...
    'cortex_subcort_l', 'cortex_subcort_r', 'cortex_subcort', 'cortex_subcort_lm', 'cortex_subcort_rm',
];
