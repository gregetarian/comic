...
def test_import_comic_is_bake_free():
    code = "import sys, comic; print('trimesh' in sys.modules, 'mne' in sys.modules)"
...
if __name__ == "__main__":
    test_import_comic_is_bake_free()
