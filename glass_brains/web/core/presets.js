...
export const FREE_DEFAULT = {
    layout: {
        ...
        panels: [
            { id: 'fc1', framing: { fit: 'auto', margin: 1.1 }, camera: { plane: 'left_lateral' }, content: { roles: ['cortex', 'voxel'], hemisphere: 'lh' }, title: 'L Lateral', view: 'left_lateral', anatomyOpacity: null, place: { x: 0.2116, y: 0.0710, w: 0.2794, h: 0.4142, z: 0 }, rotate: { yaw: -15.97, pitch: -2.06, roll: 0 } },
            { id: 'fc4', framing: { fit: 'auto', margin: 1.1 }, camera: { plane: 'right_medial' }, content: { roles: ['cortex', 'voxel'], hemisphere: 'rh' }, title: 'R Medial', view: 'right_medial', anatomyOpacity: null, place: { x: 0.2751, y: 0.3432, w: 0.4952, h: 0.6746, z: 3 }, rotate: { yaw: 330, pitch: 0, roll: -30 } },
            { id: 'fc6', framing: { fit: 'auto', margin: 1.1 }, camera: { plane: 'anterior' }, content: { roles: ['cortex', 'voxel'], hemisphere: 'both' }, title: 'Anterior', view: 'anterior', anatomyOpacity: null, place: { x: 0.3640, y: 0, w: 0.3090, h: 0.4852, z: 4 } },
            { id: 'fc7', framing: { fit: 'auto', margin: 1.1 }, camera: { plane: 'dorsal' }, content: { roles: ['cortex', 'voxel'], hemisphere: 'both' }, title: 'Dorsal', view: 'dorsal', anatomyOpacity: null, place: { x: 0.1651, y: 0.4142, w: 0.3945, h: 0.6036, z: 5 } },
        ],
    },
