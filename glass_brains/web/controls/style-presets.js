...
const KEY = 'comicbrains.stylePresets.v1';
...
export function createPresetsUI({ button, getConfig, getColormaps, getNOverlays, onApplied, download }) {
    ...
    function open() {
        ...
        exp.addEventListener('click', () => download(JSON.stringify(captureStyle(getConfig(), getNOverlays()), null, 2), 'comicbrains-style.json'));
